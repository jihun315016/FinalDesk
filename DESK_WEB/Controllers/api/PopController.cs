...
namespace DESK_WEB.Controllers
{
    ...
    public class PopController : ApiController
    {
        ...
        [HttpGet]               
        [Route("StartEq/{id}")]        
        public IHttpActionResult GetStartEquiment(string id) //work code
        {
        ...
        //https://localhost:44393/api/Pop/WorkingEqui/{id}
        //https://localhost:44393/api/Pop/WorkingEqui/WORK_20220806_0006
        //http://localhost/api/Pop/WorkingEqui/{id}
        //http://localhost/api/Pop/WorkingEqui/WORK_20220806_0006
        [HttpGet]
        [Route("WorkingEqui/{id}")]
        public IHttpActionResult GetWorkEquiment(string id) //work code
        {
            PopDAC db = new PopDAC();
            PopVO list = db.GetWorkEquiment(id);
        ...
        //https://localhost:44393/api/Pop/WorkAll/{id}
        //https://localhost:44393/api/Pop/WorkAll/WORK_20220806_0006
        //http://localhost/api/Pop/WorkAll/{id}
        //http://localhost/api/Pop/WorkAll/WORK_20220806_0006
        [HttpGet]
        [Route("WorkAll/{id}")]
