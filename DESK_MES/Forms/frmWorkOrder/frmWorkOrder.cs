...
namespace DESK_MES
{
    public partial class frmWorkOrder : FormStyle_1
    {
        ...
        private void frmWorkOrder_Load(object sender, EventArgs e)
        {
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산코드", "Production_Code", colWidth: 100);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 품목명", "Product_Name", colWidth: 60);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 계획 수량", "Planned_Qty", colWidth: 120);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 완료 수량", "Production_Qty", colWidth: 60);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 시작 예정일", "Start_Date", colWidth: 80);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 완료 예정일", "Estimated_Date", colWidth: 80);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 완료일", "Complete_Date", colWidth: 80);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 진행 상태", "Production_Status", colWidth: 60);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "작업지시코드", "Purchase_No", colWidth: 120);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "작업 품목명", "Product_Code", colWidth: 120);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "생산 수량", "TotalPrice", colWidth: 100, isVisible: false);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "작업지시수량", "Qty_PerUnit", colWidth: 90);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "작업완료수량", "TotalQty", colWidth: 110);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView2, "작업지시상태", "TotalPrice", colWidth: 100);
