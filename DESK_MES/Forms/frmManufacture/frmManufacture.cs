...
namespace DESK_MES
{
    public partial class frmManufacture : FormStyle_2
    {
        ...
        private void frmManufacture_Load(object sender, EventArgs e)
        {
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "주문서코드", "Order_No", colWidth: 60);
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 품목코드", "Product_Code", colWidth: 80);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 시작일", "Start_Date", colWidth: 80);
            ...
            DataGridUtil.SetDataGridViewColumn_TextBox(dataGridView1, "생산 계획 상태", "Production_Plan_Status", colWidth: 60);
